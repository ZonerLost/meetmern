...
class AppRoutes {
  ...
  static final pages = <GetPage>[
    ...
    GetPage(name: Routes.requestMeetup, page: () => const RequestMeetupScreen()),
    GetPage(name: Routes.viewProfile, page: () => const ViewProfileScreen()),
    GetPage(name: Routes.profileDetails, page: () => const ProfileDetailsScreen()),
    GetPage(name: Routes.personalProfile, page: () => const PersonalProfileScreen()),
    GetPage(name: Routes.personalProfileSetting, page: () => const ProfileSettingsScreen()),
    GetPage(name: Routes.setting, page: () => const SettingsScreen()),
    GetPage(name: Routes.accountPreferences, page: () => const AccountPreferencesScreen()),
    GetPage(name: Routes.blockedUsers, page: () => const BlockedUsersScreen()),
    GetPage(name: Routes.favourites, page: () => const FavouritesScreen()),
    GetPage(name: Routes.feedbackSupport, page: () => const FeedbackSupportScreen()),
