                            ...
                            builder: (ctx) {
                              return CustomModalDialog(
                                ...
                                topRightIcon: IconButton(
                                  icon:
                                      Icon(Icons.close, size: dimension.d20.sp),
                                ...
                                titleTextStyle: customButtonandTextStyles
                                    .emailLabelTextStyle,
                                ...
                                secondaryTextStyle: customButtonandTextStyles
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        CustomDropdownButton(
                                          ...
                                          items:
                                              OnboardingMockData.reportReason,
                                ...
                                onPrimary: () async {
                                  if (selectedReason == null ||
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content:
                                            Text(strings.reportValidationText),
                                      ),
                                    );
                                    return;
                                  }
                            ...
                            builder: (ctx) {
                              return CustomModalDialog(
                                ...
                                titleTextStyle: customButtonandTextStyles
                                    .emailLabelTextStyle,
                                subtitle:
                                    strings.deleteConversationDialogSubtitle,
                                subtitleTextStyle:
                                    customButtonandTextStyles.locationTextStyle,
                                primaryLabel:
                                    strings.deleteConversationPrimaryLabel,
                                primaryButtonStyle:
                                    customButtonandTextStyles.loginButtonStyle,
                                primaryTextStyle: customButtonandTextStyles
                                    .loginButtonTextStyle,
